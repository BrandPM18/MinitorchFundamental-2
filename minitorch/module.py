...
class Module:
    ...
    def named_parameters(self):
        ...
        for i in self._parameters:
            named_params[i] = self._parameters[i]

        for i in self._modules:
            descendents = self._modules[i].named_parameters()
            for j in descendents:
                named_params[i + "." + j] = descendents[j]
